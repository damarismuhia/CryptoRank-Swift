...
internal enum Asset {
  ...
  internal enum Colors {
    ...
    internal static let cardBackgroundColor = ColorAsset(name: "CardBackgroundColor")
    internal static let darkGreenColor = ColorAsset(name: "DarkGreenColor")
    internal static let darkGreyColor = ColorAsset(name: "DarkGreyColor")
    internal static let fadeGreyColor = ColorAsset(name: "FadeGreyColor")
    internal static let headerColor = ColorAsset(name: "HeaderColor")
    internal static let lightFadedGrey = ColorAsset(name: "LightFadedGrey")
